...
/**
 * Request body for cabling UI action metric emission.
 */
export interface EmitUiMetricRequest {
    /**
     * Name of the UI action being emitted.
     */
    "actionName": string;
    /**
     * String-valued dimensions to attach to the metric.
     */
...
/**
 * UiMetricsApi - object-oriented interface
 */
export class UiMetricsApi extends base.BaseAPI {
    public static createFromEndpointTemplate(fetch: base.Fetch, region: string, secondLevelDomain: string, config?: base.BaseApiConfig): UiMetricsApi {
        const endpoint = base.buildEndpointFromTemplate(
            "https://infradeliveryengineering.{region}.oci.{secondLevelDomain}",
            "/idelvv",
            region,
        ...
        return new UiMetricsApi(fetch, endpoint, config);
    }

    /**
     * Emits a cabling UI metric.
     * Emits a cabling UI action metric with string dimensions.
     * @param emitUiMetricRequest Cabling UI metric payload.
     * @param opcRequestId Request ID for idempotency
     */
    public emitUiMetric(params: {  "emitUiMetricRequest": EmitUiMetricRequest; "opcRequestId"?: string; }, options?: any): Promise<Response> {
        base.validateRequiredParameters([
            "emitUiMetricRequest",
        ], "emitUiMetric", params);

        const path = `${this.basePath}/uiMetrics`;
            ...
            headerParameters: {
                "opc-request-id":  params["opcRequestId"]
                    ...
                    body:
                    {
                        type: "content",
                        contentType: (params as any)["contentType"] ? (params as any)["contentType"] as string : "application/json",
                        content: params["emitUiMetricRequest"]
                    },


            operationName: "emitUiMetric",
            httpMethod: "POST"
        });
    }
};
